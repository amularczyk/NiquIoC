...
{
    [TestClass]
    public class ClassATransient_1_Tests
    {
        private static readonly int _testCasesNumber = 1;
        private static readonly string _fileName = Directory.GetCurrentDirectory() + "PerforamceTests_A_1_Transient_" + DateTime.Now.ToString("yyyy_MM_dd_hh_mm_ss") + ".txt";
