...
{
    [TestClass]
    public class ClassBTransient_10_Tests
    {
        private static readonly int _testCasesNumber = 10;
        private static readonly string _fileName = Directory.GetCurrentDirectory() + "PerforamceTests_B_10_Transient_" + DateTime.Now.ToString("yyyy_MM_dd_hh_mm_ss") + ".txt";
