...
namespace NiquIoC.Test.OneBigEmitFunction
{
    ...
    public class ContainerRegisterTypeWithDependencyPropertyTests
    {
        ...
        public void ClassWithManyDependencyProperties_Success()
        {
            ...
            var sampleClass = c.Resolve2<ISampleClassWithManyDependencyProperties>();
        ...
        public void ClassWithNestedDependencyProperty_Success()
        {
            ...
            var sampleClass = c.Resolve2<ISampleClassWithNestedDependencyProperty>();
        ...
        public void ClassWithDependencyPropertyWithoutSetMethod_Success()
        {
            ...
            var sampleClass = c.Resolve2<ISampleClassWithDependencyPropertyWithoutSetMethod>();
