    ...
    public class RegisterGenericTypeForInterfaceTests
    {
        ...
        public void RegisterGenericClassWithManyParameters_Success()
        {
            ...
            var genericClass = c.Resolve<IGenericClassWithManyParameters<ISampleClassWithInterfaceAsParameter,
                ISampleClassOtherWithInterfaceAsParameter>>(Enums.ResolveKind.FullEmitFunction);
        ...
        public void RegisterManyGenericClasses_Success()
        {
            ...
            var genericClass1 = c.Resolve<IGenericClass<ISampleClassWithInterfaceAsParameter>>(Enums.ResolveKind.FullEmitFunction);
            var genericClass2 = c.Resolve<IGenericClass<ISampleClassOtherWithInterfaceAsParameter>>(Enums.ResolveKind.FullEmitFunction);
