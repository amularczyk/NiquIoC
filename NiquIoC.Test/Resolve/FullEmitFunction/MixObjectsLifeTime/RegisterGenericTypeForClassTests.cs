...
namespace NiquIoC.Test.Resolve.FullEmitFunction.MixObjectsLifeTime
{
    ...
    public class RegisterGenericTypeForClassTests
    {
        ...
        public void RegisterGenericClassWithManyParameters_Success()
        {
            ...
            var genericClass = c.Resolve<GenericClassWithManyParameters<SampleClass, SampleClassOther>>(Enums.ResolveKind.FullEmitFunction);
        ...
        public void RegisterManyGenericClasses_Success()
        {
            ...
            var genericClass1 = c.Resolve<GenericClass<SampleClass>>(Enums.ResolveKind.FullEmitFunction);
            var genericClass2 = c.Resolve<GenericClass<SampleClassOther>>(Enums.ResolveKind.FullEmitFunction);
