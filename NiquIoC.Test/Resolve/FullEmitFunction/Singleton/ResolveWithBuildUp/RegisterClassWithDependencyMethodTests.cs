...
namespace NiquIoC.Test.Resolve.FullEmitFunction.Singleton.ResolveWithBuildUp
{
    ...
    public class RegisterClassWithDependencyMethodTests
    {
        ...
        public void DifferentObjects_BuildUpClassWithDependencyMethod_Success()
        {
            ...
            var sampleClass1 = c.Resolve<SampleClassWithClassDependencyMethod>(ResolveKind.FullEmitFunction);
            var sampleClass2 = c.Resolve<SampleClassWithClassDependencyMethod>(ResolveKind.FullEmitFunction);
        ...
        public void RegisterClassWithDependencyMethodWithReturnType_Fail()
        {
            ...
            var sampleClass = c.Resolve<SampleClassWithClassDependencyMethodWithReturnType>(ResolveKind.FullEmitFunction);
        ...
        public void RegisterClassWithManyClassDependencyMethods_Success()
        {
            ...
            var sampleClass = c.Resolve<SampleClassWithManyClassDependencyMethods>(ResolveKind.FullEmitFunction);
        ...
        public void DifferentObjects_RegisterClassWithManyClassDependencyMethods_Success()
        {
            ...
            var sampleClass1 = c.Resolve<SampleClassWithManyClassDependencyMethods>(ResolveKind.FullEmitFunction);
            var sampleClass2 = c.Resolve<SampleClassWithManyClassDependencyMethods>(ResolveKind.FullEmitFunction);
        ...
        public void RegisterClassWithManyClassParametersInDependencyMethod_Success()
        {
            ...
            var sampleClass = c.Resolve<SampleClassWithManyClassParametersInDependencyMethod>(ResolveKind.FullEmitFunction);
        ...
        public void DifferentObjects_RegisterClassWithManyClassParametersInDependencyMethod_Success()
        {
            ...
            var sampleClass1 = c.Resolve<SampleClassWithManyClassParametersInDependencyMethod>(ResolveKind.FullEmitFunction);
            var sampleClass2 = c.Resolve<SampleClassWithManyClassParametersInDependencyMethod>(ResolveKind.FullEmitFunction);
        ...
        public void RegisterClassWithNestedClassDependencyMethod_Success()
        {
            ...
            var sampleClass = c.Resolve<SampleClassWithNestedClassDependencyMethod>(ResolveKind.FullEmitFunction);
        ...
        public void DifferentObjects_RegisterClassWithNestedClassDependencyMethod_Success()
        {
            ...
            var sampleClass1 = c.Resolve<SampleClassWithNestedClassDependencyMethod>(ResolveKind.FullEmitFunction);
            var sampleClass2 = c.Resolve<SampleClassWithNestedClassDependencyMethod>(ResolveKind.FullEmitFunction);
