...
namespace NiquIoC.Test.PartialEmitFunction.MixObjectsLifeTime.SingletonAndTransient
{
    ...
    public class RegisterGenericTypeForInterfaceTests
    {
        ...
        public void RegisterGenericClassWithManyParameters_Success()
        {
            ...
            c
                .RegisterType<
                    IGenericClassWithManyParameters<ISampleClassWithInterfaceAsParameter,
                        ISampleClassOtherWithInterfaceAsParameter>, GenericClassWithManyParameters<
                        ISampleClassWithInterfaceAsParameter, ISampleClassOtherWithInterfaceAsParameter>>();

            var genericClass =
                c
                    .Resolve<IGenericClassWithManyParameters<ISampleClassWithInterfaceAsParameter,
                        ISampleClassOtherWithInterfaceAsParameter>>(ResolveKind.PartialEmitFunction);
        ...
        public void RegisterManyGenericClasses_Success()
        {
            ...
            var genericClass2 =
                c.Resolve<IGenericClass<ISampleClassOtherWithInterfaceAsParameter>>(ResolveKind.PartialEmitFunction);
