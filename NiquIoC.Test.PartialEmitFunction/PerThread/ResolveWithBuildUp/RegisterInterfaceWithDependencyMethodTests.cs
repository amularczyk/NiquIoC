...
namespace NiquIoC.Test.PartialEmitFunction.PerThread.ResolveWithBuildUp
{
    ...
    public class RegisterInterfaceWithDependencyMethodTests
    {
        ...
        public void RegisterInterfaceAsClassWithDependencyMethodWithReturnType_Fail()
        {
            ...
            {
                sampleClass =
                    c.Resolve<ISampleClassWithInterfaceMethodWithReturnType>(ResolveKind.PartialEmitFunction);
            });
            thread.Start();
            thread.Join();
        ...
        public void RegisterInterfaceAsClassWithManyInterfaceDependencyMethods_Success()
        {
            ...
            {
                sampleClass =
                    c.Resolve<ISampleClassWithManyInterfaceDependencyMethods>(ResolveKind.PartialEmitFunction);
            });
            thread.Start();
            thread.Join();
        ...
        public void RegisterInterfaceAsClassWithManyInterfaceParametersInDependencyMethod_Success()
        {
            ...
            {
                sampleClass =
                    c.Resolve<ISampleClassWithManyInterfaceParametersInDependencyMethod>(ResolveKind
                        .PartialEmitFunction);
            });
            thread.Start();
            thread.Join();
        ...
        public void SameThread_DifferentObjects_RegisterInterfaceWithManyInterfaceParametersInDependencyMethod_Success()
        {
            ...
            {
                sampleClass1 =
                    c.Resolve<ISampleClassWithManyInterfaceParametersInDependencyMethod>(
        ...
        [TestMethod]
        public void
            DifferentThreads_DifferentObjects_RegisterInterfaceWithManyInterfaceParametersInDependencyMethod_Success()
        {
            var c = new Container();
            c.RegisterType<IEmptyClass, EmptyClass>().AsPerThread();
            c.RegisterType<ISampleClassWithInterfaceAsParameter, SampleClassWithInterfaceAsParameter>().AsPerThread();
        ...
        public void RegisterInterfaceAsClassWithNestedInterfaceDependencyMethod_Success()
        {
            ...
            {
                sampleClass =
                    c.Resolve<ISampleClassWithNestedInterfaceDependencyMethod>(ResolveKind.PartialEmitFunction);
            });
            thread.Start();
            thread.Join();
