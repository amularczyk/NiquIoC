...
namespace NiquIoC.Test.PerHttpContext.PartialEmitFunction.DependencyConstrutor
{
    ...
    public class RegisterTypeForClassWithDependencyConstrutorWithInterfaceTests
    {
        ...
        public void RegisteredInterfaceAsClassWithInterfaceAsParameterAndWithConstructorWithAttributeDependencyConstrutor_Success()
        {
            ...
            var result = controller.ResolveObject<SampleClassWithInterfaceAsParameterWithDependencyConstrutor>(c, ResolveKind.PartialEmitFunction);
        ...
        public void RegisteredInterfaceAsClassWithInterfaceAsParameterAndWithTwoConstructorsWithAttributeDependencyConstrutor_Fail()
        {
            ...
            var controller = new DefaultController();
            HttpContext.Current = new HttpContext(new HttpRequest("", "http://tempuri.org", ""), new HttpResponse(new StringWriter()));
            var result = controller.ResolveObject<SampleClassWithInterfaceAsParameterWithTwoDependencyConstrutor>(c, ResolveKind.PartialEmitFunction);
