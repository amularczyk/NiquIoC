...
namespace NiquIoC.Test.PerHttpContext.PartialEmitFunction.FactoryObject
{
    ...
    public class RegisterTypeByFactoryObjectForClassWithInterfaceTests
    {
        ...
        public void FactoryObjectReturnNewObject_Success()
        {
            ...
            var result1 = controller.ResolveObject<SampleClassWithInterfaceAsParameter>(c, ResolveKind.PartialEmitFunction);
            var sampleClass1 = (SampleClassWithInterfaceAsParameter)((ViewResult)result1).Model;
            var result2 = controller.ResolveObject<SampleClassWithInterfaceAsParameter>(c, ResolveKind.PartialEmitFunction);
