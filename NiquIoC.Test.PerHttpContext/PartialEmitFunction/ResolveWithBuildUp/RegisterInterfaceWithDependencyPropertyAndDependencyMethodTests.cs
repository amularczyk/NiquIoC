...
namespace NiquIoC.Test.PerHttpContext.PartialEmitFunction.ResolveWithBuildUp
{
    ...
    public class RegisterInterfaceWithDependencyPropertyAndDependencyMethodTests
    {
        ...
        public void RegisterInterfaceWithDependencyPropertyAndDependencyMethod_Success()
        {
            ...
            var sampleClass = TestsHelper.ResolveObject<ISampleClassWithInterfaceDependencyPropertyAndDependencyMethodWithSameType>(c, ResolveKind.PartialEmitFunction);
        ...
        public void SameThread_DifferentObjects_RegisterInterfaceWithDependencyPropertyAndDependencyMethod_Success()
        {
            ...
            {
                sampleClass1 = c.Resolve<ISampleClassWithInterfaceDependencyPropertyAndDependencyMethodWithSameType>(ResolveKind.PartialEmitFunction);
                sampleClass2 = c.Resolve<ISampleClassWithInterfaceDependencyPropertyAndDependencyMethodWithSameType>(ResolveKind.PartialEmitFunction);
            });
            thread.Start();
            thread.Join();
        ...
        public void DifferentThreads_DifferentObjects_RegisterInterfaceWithDependencyPropertyAndDependencyMethod_Success()
        {
            ...
            var sampleClass1 = TestsHelper.ResolveObject<ISampleClassWithInterfaceDependencyPropertyAndDependencyMethodWithSameType>(c, ResolveKind.PartialEmitFunction);
            var sampleClass2 = TestsHelper.ResolveObject<ISampleClassWithInterfaceDependencyPropertyAndDependencyMethodWithSameType>(c, ResolveKind.PartialEmitFunction);
        ...
        public void RegisterInterfaceWithDependencyPropertyAndDependencyMethodWithDifferentTypes_Success()
        {
            ...
            var sampleClass = TestsHelper.ResolveObject<ISampleClassWithInterfaceDependencyPropertyAndDependencyMethodWithDifferentTypes>(c, ResolveKind.PartialEmitFunction);
        ...
        [TestMethod]
        public void SameThread_DifferentObjects_RegisterInterfaceWithDependencyPropertyAndDependencyMethodWithDifferentTypes_Success()
        {
            var c = new Container();
            c.RegisterType<IEmptyClass, EmptyClass>().AsPerHttpContext();
            c.RegisterType<ISampleClassWithInterfaceAsParameter, SampleClassWithInterfaceAsParameter>().AsPerHttpContext();
            ...
            var thread = new Thread(() =>
            {
                sampleClass1 = c.Resolve<ISampleClassWithInterfaceDependencyPropertyAndDependencyMethodWithDifferentTypes>(ResolveKind.PartialEmitFunction);
                sampleClass2 = c.Resolve<ISampleClassWithInterfaceDependencyPropertyAndDependencyMethodWithDifferentTypes>(ResolveKind.PartialEmitFunction);
            });
            thread.Start();
            thread.Join();
        ...
        public void DifferentThreads_DifferentObjects_RegisterInterfaceWithDependencyPropertyAndDependencyMethodWithDifferentTypes_Success()
        {
            ...
            var sampleClass1 = TestsHelper.ResolveObject<ISampleClassWithInterfaceDependencyPropertyAndDependencyMethodWithDifferentTypes>(c, ResolveKind.PartialEmitFunction);
            var sampleClass2 = TestsHelper.ResolveObject<ISampleClassWithInterfaceDependencyPropertyAndDependencyMethodWithDifferentTypes>(c, ResolveKind.PartialEmitFunction);
