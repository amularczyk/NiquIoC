...
namespace NiquIoC.Test.PerHttpContext.PartialEmitFunction
{
    ...
    public class RegisterGenericTypeForClassTests
    {
        ...
        public void RegisterSimpleGenericClass_Success()
        {
            ...
            var genericClass = TestsHelper.ResolveObject<GenericClass<EmptyClass>>(c, ResolveKind.PartialEmitFunction);
        ...
        public void RegisterGenericClassWithClassWithNestedClass_Success()
        {
            ...
            var genericClass = TestsHelper.ResolveObject<GenericClass<SampleClass>>(c, ResolveKind.PartialEmitFunction);
        ...
        public void RegisterGenericClassWithManyParameters_Success()
        {
            ...
            var genericClass = TestsHelper.ResolveObject<GenericClassWithManyParameters<EmptyClass, SampleClass>>(c, ResolveKind.PartialEmitFunction);
        ...
        public void DifferentHttpContexts_RegisterManyGenericClasses_Success()
        {
            ...
            var genericClass1 = TestsHelper.ResolveObject<GenericClass<EmptyClass>>(c, ResolveKind.PartialEmitFunction);
            var genericClass2 = TestsHelper.ResolveObject<GenericClass<SampleClass>>(c, ResolveKind.PartialEmitFunction);
