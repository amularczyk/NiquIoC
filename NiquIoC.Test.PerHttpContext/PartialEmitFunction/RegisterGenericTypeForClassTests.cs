...
namespace NiquIoC.Test.PerHttpContext.PartialEmitFunction
{
    ...
    public class RegisterGenericTypeForClassTests
    {
        ...
        public void RegisterSimpleGenericClass_Success()
        {
            ...
            var result = controller.ResolveObject<GenericClass<EmptyClass>>(c, ResolveKind.PartialEmitFunction);
        ...
        public void RegisterGenericClassWithClassWithNestedClass_Success()
        {
            ...
            var controller = new DefaultController();
            HttpContext.Current = new HttpContext(new HttpRequest("", "http://tempuri.org", ""), new HttpResponse(new StringWriter()));
            var result = controller.ResolveObject<GenericClass<SampleClass>>(c, ResolveKind.PartialEmitFunction);
        ...
        public void RegisterGenericClassWithManyParameters_Success()
        {
            ...
            var controller = new DefaultController();
            HttpContext.Current = new HttpContext(new HttpRequest("", "http://tempuri.org", ""), new HttpResponse(new StringWriter()));
            var result = controller.ResolveObject<GenericClassWithManyParameters<EmptyClass, SampleClass>>(c, ResolveKind.PartialEmitFunction);
        ...
        public void SameThread_RegisterManyGenericClasses_Success()
        {
            ...
            var controller = new DefaultController();
            HttpContext.Current = new HttpContext(new HttpRequest("", "http://tempuri.org", ""), new HttpResponse(new StringWriter()));
            var result1 = controller.ResolveObject<GenericClass<EmptyClass>>(c, ResolveKind.PartialEmitFunction);
            var genericClass1 = (GenericClass<EmptyClass>)((ViewResult)result1).Model;
            var result2 = controller.ResolveObject<GenericClass<SampleClass>>(c, ResolveKind.PartialEmitFunction);
