...
namespace NiquIoC.Test.PerHttpContext.FullEmitFunction.ReRegister
{
    ...
    public class ReRegistereInterfaceTests
    {
        ...
        public void InterfaceReRegisteredFromInstanceToInstance_Success()
        {
            ...
            var result1 = controller.ResolveObject<IEmptyClass>(c, ResolveKind.FullEmitFunction);
            var emptyClass1 = (IEmptyClass)((ViewResult)result1).Model;
            var result2 = controller.ResolveObject<IEmptyClass>(c, ResolveKind.FullEmitFunction);
            ...
            var result4 = controller.ResolveObject<IEmptyClass>(c, ResolveKind.FullEmitFunction);
            var emptyClass4 = (IEmptyClass)((ViewResult)result4).Model;
            var result5 = controller.ResolveObject<IEmptyClass>(c, ResolveKind.FullEmitFunction);
        ...
        public void InterfaceReRegisteredFromObjectFactoryToObjectFactory_Success()
        {
            ...
            var result3 = controller.ResolveObject<IEmptyClass>(c, ResolveKind.FullEmitFunction);
        ...
        public void InterfaceReRegisteredFromOneClassToTheOther_Success()
        {
            ...
            var result3 = controller.ResolveObject<ISampleClass>(c, ResolveKind.FullEmitFunction);
            var sampleClass3 = (ISampleClass)((ViewResult)result3).Model;
            var result4 = controller.ResolveObject<ISampleClass>(c, ResolveKind.FullEmitFunction);
