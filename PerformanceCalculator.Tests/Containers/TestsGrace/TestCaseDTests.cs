...
namespace PerformanceCalculator.Tests.Containers.TestsGrace
{
    ...
    public class TestCaseDTests
    {
        ...
        {
            ITestCase testCase = new TransientSingletonTestCaseD(new GraceRegistration(), new GraceResolving());
        ...
        {
            ITestCase testCase = new FactoryMethodTestCaseD(new GraceRegistration(), new GraceResolving());
