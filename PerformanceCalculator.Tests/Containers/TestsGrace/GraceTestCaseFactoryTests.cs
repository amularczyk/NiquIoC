...
{
    [TestClass]
    public class GraceTestCaseFactoryTests
    {
        public class FakeGracePerformanceTest : GracePerformanceTest
        {
        ...
        private FakeGracePerformanceTest GetPerformance()
        {
            return new FakeGracePerformanceTest();
        }
