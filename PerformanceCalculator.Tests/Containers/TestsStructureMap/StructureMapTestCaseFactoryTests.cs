...
{
    [TestClass]
    public class StructureMapTestCaseFactoryTests
    {
        public class FakeStructureMapPerformanceTest : StructureMapPerformanceTest
        {
        ...
        private FakeStructureMapPerformanceTest GetPerformance()
        {
            return new FakeStructureMapPerformanceTest();
        }
