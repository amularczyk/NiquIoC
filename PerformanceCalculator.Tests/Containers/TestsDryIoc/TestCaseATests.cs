...
namespace PerformanceCalculator.Tests.Containers.TestsDryIoc
{
    ...
    public class TestCaseATests
    {
        ...
        {
            ITestCase testCase = new TransientSingletonTestCaseA(new DryIocRegistration(), new DryIocResolving());
        ...
        {
            ITestCase testCase = new FactoryMethodTestCaseA(new DryIocRegistration(), new DryIocResolving());
