...
{
    [TestClass]
    public class DryIocTestCaseFactoryTests
    {
        public class FakeDryIocPerformanceTest : DryIocPerformanceTest
        {
        ...
        private FakeDryIocPerformanceTest GetPerformance()
        {
            return new FakeDryIocPerformanceTest();
        }
