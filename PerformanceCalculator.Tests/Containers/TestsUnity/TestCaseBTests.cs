...
namespace PerformanceCalculator.Tests.Containers.TestsUnity
{
    ...
    public class TestCaseBTests
    {
        ...
        {
            ITestCase testCase = new TransientTestCaseB(new UnityRegistration(), new UnityResolving());
        ...
        {
            ITestCase testCase = new TransientSingletonTestCaseB(new UnityRegistration(), new UnityResolving());
        ...
        {
            ITestCase testCase = new FactoryMethodTestCaseB(new UnityRegistration(), new UnityResolving());
