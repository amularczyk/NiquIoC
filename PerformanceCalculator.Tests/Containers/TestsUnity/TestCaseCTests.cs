...
namespace PerformanceCalculator.Tests.Containers.TestsUnity
{
    ...
    public class TestCaseCTests
    {
        ...
        {
            ITestCase testCase = new TransientSingletonTestCaseC(new UnityRegistration(), new UnityResolving());
        ...
        {
            ITestCase testCase = new FactoryMethodTestCaseC(new UnityRegistration(), new UnityResolving());
