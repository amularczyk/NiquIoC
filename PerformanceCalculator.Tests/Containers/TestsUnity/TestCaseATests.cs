...
namespace PerformanceCalculator.Tests.Containers.TestsUnity
{
    ...
    public class TestCaseATests
    {
        ...
        {
            ITestCase testCase = new SingletonTestCaseA(new UnityRegistration(), new UnityResolving());
        ...
        {
            ITestCase testCase = new TransientTestCaseA(new UnityRegistration(), new UnityResolving());
        ...
        {
            ITestCase testCase = new TransientSingletonTestCaseA(new UnityRegistration(), new UnityResolving());

            var c = new UnityContainer();
            c = (UnityContainer)testCase.Register(c, RegistrationKind.TransientSingleton);
        ...
        {
            ITestCase testCase = new PerThreadTestCaseA(new UnityRegistration(), new UnityResolving());
        ...
        {
            ITestCase testCase = new FactoryMethodTestCaseA(new UnityRegistration(), new UnityResolving());
