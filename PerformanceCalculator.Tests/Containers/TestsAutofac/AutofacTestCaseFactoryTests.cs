...
{
    [TestClass]
    public class AutofacTestCaseFactoryTests
    {
        public class FakeAutofacPerformanceTest : AutofacPerformanceTest
        {
        ...
        private FakeAutofacPerformanceTest GetPerformance()
        {
            return new FakeAutofacPerformanceTest();
        }
