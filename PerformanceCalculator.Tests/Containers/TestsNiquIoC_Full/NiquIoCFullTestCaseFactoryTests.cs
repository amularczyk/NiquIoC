...
{
    [TestClass]
    public class NiquIoCFullTestCaseFactoryTests
    {
        public class FakeNiquIoCFullPerformanceTest : NiquIoCFullPerformanceTest
        {
        ...
        private FakeNiquIoCFullPerformanceTest GetPerformance()
        {
            return new FakeNiquIoCFullPerformanceTest();
        }
