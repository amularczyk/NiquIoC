...
namespace PerformanceCalculator.Tests.Containers.TestsNiquIoC_Partial
{
    ...
    public class TestCaseATests
    {
        ...
        {
            ITestCase testCase = new TestCaseA(new SingletonNiquIoCPartialRegistration(), new NiquIoCPartialResolving());
        ...
        {
            ITestCase testCase = new TestCaseA(new TransientNiquIoCPartialRegistration(), new NiquIoCPartialResolving());
        ...
        {
            ITestCase testCase = new TestCaseA(new PerThreadNiquIoCPartialRegistration(), new NiquIoCPartialResolving());
