...
{
    [TestClass]
    public class NiquIoCPartialTestCaseFactoryTests
    {
        public class FakeNiquIoCPartialPerformanceTest : NiquIoCPartialPerformanceTest
        {
        ...
        private FakeNiquIoCPartialPerformanceTest GetPerformance()
        {
            return new FakeNiquIoCPartialPerformanceTest();
        }
