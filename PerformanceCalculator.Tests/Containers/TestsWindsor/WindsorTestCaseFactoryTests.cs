...
{
    [TestClass]
    public class WindsorTestCaseFactoryTests
    {
        public class FakeWindsorPerformanceTest : WindsorPerformanceTest
        {
        ...
        private FakeWindsorPerformanceTest GetPerformance()
        {
            return new FakeWindsorPerformanceTest();
        }
