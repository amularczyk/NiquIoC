...
{
    [TestClass]
    public class NinjectTestCaseFactoryTests
    {
        private FakeNinjectPerformanceTest GetPerformance()
        {
            return new FakeNinjectPerformanceTest();
        }
        ...
        public class FakeNinjectPerformanceTest : NinjectPerformanceTest
        {
