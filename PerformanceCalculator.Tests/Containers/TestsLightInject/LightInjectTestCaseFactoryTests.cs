...
{
    [TestClass]
    public class LightInjectTestCaseFactoryTests
    {
        public class FakeLightInjectPerformanceTest : LightInjectPerformanceTest
        {
        ...
        private FakeLightInjectPerformanceTest GetPerformance()
        {
            return new FakeLightInjectPerformanceTest();
        }
