    ...
    public class RegisterTypeForClassTests
    {
        ...
        public void RegisterClassWithConstructorWithoutParameters_Success()
        {
            ...
            var emptyClass = HttpContextTestsHelper.Initialize()
                .ResolveObject<EmptyClass>(c, ResolveKind.FullEmitFunction);
        ...
        public void InternalClassNotRegistered_Fail()
        {
            ...
            var sampleClass = HttpContextTestsHelper.Initialize()
                .ResolveObject<SampleClass>(c, ResolveKind.FullEmitFunction);
        ...
        public void InternalStringTypeNotRegistered_Fail()
        {
            ...
            var sampleClass = HttpContextTestsHelper.Initialize()
                .ResolveObject<SampleClassWithStringType>(c, ResolveKind.FullEmitFunction);
        ...
        public void InternalIntTypeNotRegistered_Fail()
        {
            ...
            var sampleClass = HttpContextTestsHelper.Initialize()
                .ResolveObject<SampleClassWithIntType>(c, ResolveKind.FullEmitFunction);
        ...
        public void RegisterClassWithCycleInConstructor_Fail()
        {
            ...
            var sampleClass = HttpContextTestsHelper.Initialize()
                .ResolveObject<FirstClassWithCycleInConstructor>(c, ResolveKind.FullEmitFunction);
