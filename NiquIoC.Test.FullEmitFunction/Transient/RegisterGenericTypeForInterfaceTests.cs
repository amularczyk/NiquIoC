...
namespace NiquIoC.Test.FullEmitFunction.Transient
{
    ...
    public class RegisterGenericTypeForInterfaceTests
    {
        ...
        public void RegisterSimpleGenericClass_Success()
        {
            ...
            var genericClass = c.Resolve<IGenericClass<IEmptyClass>>(ResolveKind.FullEmitFunction);
        ...
        public void RegisterGenericClassWithManyParameters_Success()
        {
            ...
            c.RegisterType<ISampleClassWithInterfaceAsParameter, SampleClassWithInterfaceAsParameter>();
            c
                .RegisterType<IGenericClassWithManyParameters<IEmptyClass, ISampleClassWithInterfaceAsParameter>,
