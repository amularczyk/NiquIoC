...
namespace NiquIoC.Test.FullEmitFunction.Singleton
{
    ...
    public class RegisterGenericTypeForClassTests
    {
        ...
        public void RegisterSimpleGenericClass_Success()
        {
            ...
            var genericClass = c.Resolve<GenericClass<EmptyClass>>(ResolveKind.FullEmitFunction);
        ...
        public void RegisterGenericClassWithClassWithNestedClass_Success()
        {
            ...
            var genericClass = c.Resolve<GenericClass<SampleClass>>(ResolveKind.FullEmitFunction);
