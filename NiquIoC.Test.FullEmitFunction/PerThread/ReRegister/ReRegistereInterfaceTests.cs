...
namespace NiquIoC.Test.FullEmitFunction.PerThread.ReRegister
{
    [TestClass]
    public class ReRegistereInterfaceTests
    {
        ...
        public void InterfaceReRegisteredFromOneClassToTheOther_Success()
        {
            ...
            var thread = new Thread(() =>
            {
                ...
                sampleClass3 = c.Resolve<ISampleClass>(ResolveKind.FullEmitFunction);
                sampleClass4 = c.Resolve<ISampleClass>(ResolveKind.FullEmitFunction);
            });
            thread.Start();
            thread.Join();
